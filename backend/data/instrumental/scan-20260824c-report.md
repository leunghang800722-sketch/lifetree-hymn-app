...
| **T3 回標總數** | **90** | `apply-20260824c.json` |
...
_(表只列頭 50 首,全份 811 首喺 `scan-20260824c.json` 嘅 `observe` 陣列。呢個數字大係正常:whisper 幻覺 loop 喺全庫好普遍,而呢啲歌係靠 OCR 做到 verified 嘅。)_
