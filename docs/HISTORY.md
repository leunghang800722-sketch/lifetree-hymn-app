# HANDOFF 歷史歸檔（2026-07-15 → 2026-07-25）

> 呢個係**舊版 HANDOFF.md 嘅原文備份**,一個字冇改過(2026-07-25 精簡前嘅完整版)。
> 主文件 [`HANDOFF.md`](../HANDOFF.md) 而家淨係留「現況 + 紅線規矩」,
> 所有逐個版本嘅 bug 診斷過程、覆測清單、決策經過都喺呢度搵返。
>
> ⚠️ **呢份係唯讀歷史,唔好再更新。** 入面好多數字/狀態(版本號、歌庫數量、
> 「未做/未試」嘅標記)喺當時啱,而家已經過時 —— 要現況請睇主文件。
> Fable 5 監督記錄已搬去 [`SUPERVISION-LOG.md`](SUPERVISION-LOG.md)。
